...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sap/fe/demo/funcionarios/funcionarios/test/integration/FirstJourney",
    "sap/fe/demo/funcionarios/funcionarios/test/integration/FuncionariosListJourney",
    "sap/fe/demo/funcionarios/funcionarios/test/integration/FuncionariosObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
