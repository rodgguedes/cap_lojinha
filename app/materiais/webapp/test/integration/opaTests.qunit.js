...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "sap/fe/demo/materiais/test/integration/FirstJourney",
    "sap/fe/demo/materiais/test/integration/MateriaisListJourney",
    "sap/fe/demo/materiais/test/integration/MateriaisObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
